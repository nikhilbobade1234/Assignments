...
public static void main(String[] args) {
	...
	System.out.println("Enter data of manufacturing");
	String c=sc.next();
	
	List<Item>s1=slist.stream().filter(s->s.dom.equals(c)).collect(Collectors.toList());
	for(Item s2:s1) 
